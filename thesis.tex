  ...
  \section{Bedienung, Reporting und Geschwindigkeit}
    ...
    \subsection{Kommerziell}
     ...
     \begin{table}[H]
       ...
       \hline
       \textbf{Kommerzielle WVS}       & \textbf{Acunetix} & \textbf{BurpSuite Pro} & \textbf{Nessus} & \textbf{Netsparker}  \\
       \hline
...
\chapter{Diskussion}
  ...
  Es sind keine Regelmäßigkeiten erkennbar und so lässt sich die erste Forschungsfrage \textbf{Wie viele Schwachstellen werden von den WVS gefunden?} nur in absoluten Zahlen pro WVS beantworten.
