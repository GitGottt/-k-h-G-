...
\chapter{Methodik}
  ...
  Zunächst wurden die verwundbare Web-Applikation gescannt und ein entsprechender Bericht generiert, anhand dessen die gefundenen Schwachstellen typisiert und werden konnten. Der beim Testen entstandene subjektive Eindruck der Handhabung und Bedienbarkeit, fließt zusammen mit Scangeschwindigkeit in die Evaluation mit ein. %Um die True und False Positives zu identifizieren war es notwendig, die gefundenen Schwachstellen anhand von Dokumentationen der Websites oder manuell zu validieren und die Ergenisse zu vergleichen.
