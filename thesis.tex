...
\section{Web Vulnerability Scanner (WVS)}
  ...
  \subsection{Nicht ausgewählte WVS}
    ...
    \begin{itemize}
      ...
      \item Vega: Das aktuelle Release ist aus dem Jahr 2014, seit diesem Jahr wird in regelmäßigen Abständen angekündigt, ein Feature zum Exportieren der Ergebnisse hinzuzufügen, aber die Firma Subgraph scheint das Projekt nicht weiter zu verfolgen.\cite{Vega}
...
\section{Verwundbare Web-Applikationen}
  Bei der Auswahl der Web-Applikationen musste darauf geachtet werden, dass sie für WVS geeignet sind. Die ursprünglich vorgesehenen Applikationen WebGoat und JuiceShop (beide von OWASP) sind zwar sehr gut dokumentiert, aber dafür entwickelt worden, manuell Schwachstellen anzugreifen.
    ...
    \subsubsection{Open Source}
        \begin{itemize}
          \item Arachni:\\
            ...
            \end{figure}
          \item GoLismero:\\
            GoLismero ist ein in Python geschriebenes Framework, das verschiedene Penetrationtesting-Tools in sich vereint. Bei einem Angriff werden alle Tools angewendet und die jeweiligen Ergebnisse in einem einzigen Report gebündelt. Anwendungen wie nmap, nikto, sqlmap, theHarvester oder xsser sind bereits im Bundle enthalten und werden ohne weitere Konfiguration automatisch aufgerufen. Mit Hilfe von Plugins und dem Einbinden von APIs können weitere Tools wie z.B. OpenVAS, Shodan oder Wfuzz hinzugefügt werden. Bei den Tests wurde GoLismero out of the Box ohne zusätzlich eingebundene Tools verwendet.
          \item OpenVAS:\\

          \begin{figure}[!htb]
            \includegraphics[width=1\textwidth]{Images/OpenVAS}
            \caption[OpenVAS Web-Interface]{OpenVAS Web-Interface}
          \end{figure}
          \item Wapiti:
          \item Wfuzz:
          \item W3af:
