...
In dieser Arbeit werden aktuelle Open Source Web Application Vulnerability Scanner auf ihren Umfang und ihre Tauglichkeit überprüft und verglichen. Jeder Scanner wird an verschiedenen Web-Seiten getestet, die absichtlich eingebaute Schwachstellen haben, wie z.B. Juice-Shop oder Damn Vulnerable Web Application. Kriterien für die Bewertung der Tools sind Anzahl der gefundenen Schwachstellen, Anzahl der False Positives und die daraus resultierende Trefferquote.
...
\chapter{Scanner}
  \section{Kandidaten und Auswahlkriterien}
  TODO
  \section{Ausgewählte Scanner}
  TODO
  \section{Nicht ausgewählte Scanner}
  TODO

\chapter{Verwundbare Web-Applikationen}
  \section{OWASP Juice Shop}
  TODO
  \section{Damn Vulnerable Web Application}
  TODO
  \section{Altoro Mutual}
  TODO
  \section{Webscantest}
  TODO
  \section{Security Tweets}
  TODO
...
\chapter{Testen}
  ...
  1. Scannen der Web-Applikationen\\\\
  2. Report erstellen\\\\
  3. Gefundene Schwachstellen analysieren\\\\
  4. Schwachstellen manuell validieren\\\\
  5. Ergebnisse vergleichen\\\\
  6. True und False Positives identifizieren\\\\
...
\chapter{Bewertung der Ergebnisse}
  \section{Vergleich aller Scanner}
  TODO
  \section{Vergleich Open Source vs. Kommerziell}
  TODO
  \section{Handhabung und Bedienbarkeit}
  TODO
